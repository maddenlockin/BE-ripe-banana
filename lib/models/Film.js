...
module.exports = class Film {
    ...
    static async getFilmsById(id) {
        ...
        const reviewsRows = reviews.rows[0];
        ...
        return {
            ...
            reviews: [
                {
                    id: reviewsRows.review_id,
                    rating: reviewsRows.rating,
                    review: reviewsRows.review,
                    reviewer: {
                        id: reviewsRows.reviewer_id,
                        name: reviewsRows.reviewer_name,
                    },
                },
            ],
        };
